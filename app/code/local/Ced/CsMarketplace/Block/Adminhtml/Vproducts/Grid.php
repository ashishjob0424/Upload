   ...
   protected function _prepareCollection()
    {
    	...
    	if(Mage::registry('usePendingProductFilter')){
				$vproducts = Mage::getModel('csmarketplace/vproducts')->getVendorProducts(Ced_CsMarketplace_Model_Vproducts::PENDING_STATUS,$vendor_id,0,-1);
    			...
    			$vproducts = Mage::getModel('csmarketplace/vproducts')->getVendorProducts(Ced_CsMarketplace_Model_Vproducts::APPROVED_STATUS,$vendor_id,0,-1);
    			Mage::unregister('useApprovedProductFilter');
    			Mage::unregister('usePendingProductFilter');
    	} else {
			$vproducts = Mage::getModel('csmarketplace/vproducts')->getVendorProducts('',$vendor_id,0,-1);
		}
